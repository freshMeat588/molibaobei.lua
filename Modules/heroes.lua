...
--<<<<<<< HEAD
  self:logInfo('当前页面，物品槽位：   ', statusPage, heroItemSlotSelected);
--=======
...
--<<<<<<< HEAD
  self:logInfo('玩家号，队友号，物品槽位：   ', charIndex,heroData.index,heroItemSlotSelected);
--=======
-->>>>>>> 24aed14c3e243632f864d48c6368dc111130e4e7
...
--<<<<<<< HEAD
  self:logInfo('队友号，玩家页面，玩家物品槽位，玩家物品号：   ', heroIndex,playerPage, playerSlot, playerItemIndex);
--=======
...
--<<<<<<< HEAD
  self:logInfo('队友物品槽位选中的，队友物品号，队友物品数据对象', heroItemSlotSelected, heroItemIndex, heroItemData);
--=======
-->>>>>>> 24aed14c3e243632f864d48c6368dc111130e4e7
...
--<<<<<<< HEAD
    self:logInfo('战斗号，位置，角色号：   ', battleIndex,pos,charIndex);
--=======
-->>>>>>> 24aed14c3e243632f864d48c6368dc111130e4e7
		if charIndex<0 then
      return
...
--<<<<<<< HEAD
    self:logInfo('dummy号：   ',dummyIndex );
--=======
...
--<<<<<<< HEAD
    self:logInfo('是假人或不是：   ', Char.IsDummy(dummyIndex));
--=======
...
--<<<<<<< HEAD
    self:logInfo('是英雄或不是：   ', heroesOnline[dummyIndex]);
--=======
-->>>>>>> 24aed14c3e243632f864d48c6368dc111130e4e7
...
--<<<<<<< HEAD
    self:logInfo('英雄拥有者槽位：   ', ownerSlot);
--=======
...
--<<<<<<< HEAD
    self:logInfo('loaded heroesAI', aiId,aiData,commands);
    print("aidata:   ",JSON.stringify(aiData))
    print("command:   ",JSON.stringify(commands))
    print("开始计算")
    self:logInfo('机器人号，我方还是敌方，战斗号，站位槽位，命令集：   ', dummyIndex,side,battleIndex,pos,commands);
--=======
